...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		getBlockFooter: function(node)
		{
			...
			node.appendChild(
				BX.create('DIV', {
					props: {className: 'row bx-soa-more hidden'},
					children: [
						BX.create('DIV', {
			...
			else if (column.id == 'SUM')
			{
				...
				textNode.appendChild(
										BX.create(
													'A', {
														props: {
															className: 'bx-soa-item-remove', 
															href: '/personal/cart-order/?basketAction=delete&id=' + allData.id
														},
														text: 'x'
													}
												)
		...
		editCoupons: function(basketItemsNode)
		{
			...
			basketItemsNode.appendChild(
				BX.create('DIV', {
					props: {className: 'bx-soa-coupon hidden'},
					children: [
						couponsLabel,
						couponsBlock
					]
