				...
				<div>
					...
					foreach ($arSource as $arProperties)
					{
						if ($arProperties["TYPE"] == "CHECKBOX")
						{
							...
							<? 
								// Если товар на заказ из Германии, то не отображаем название
								if($arProperties["CODE"] != 'from_germany'): ?>
							...
							<div class="bx_block r1x3 pt8">
								...
								<?
									...
									// Если товар на заказ из Германии, то делаем выбранным
								?>
									<input type="hidden" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" value="Y" checked="">
								<?endif;?>
