...
$MESS['SOA_TEMPL_ORDER_SUC1'] = "Наши менеджеры свяжутся с Вами в ближайшее время.";
...
$MESS['SOA_TEMPL_END_TEXT'] = "<b>*</b> - Стоимость без учета доставки. Точная стоимость доставки уточняется менеджером при подтверждении заказа.";
?>