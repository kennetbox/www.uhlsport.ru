...
<?/* [Открывается в файле \bitrix\templates\uhlsport\components\bitrix\catalog.section\catalog.section.before\template.php]
<div class="feature_gloves">
	<div class="container_16">
		<div class="grid_12">
			<ul id="productlist" class="image-grid image-grid-left">
*/?>
