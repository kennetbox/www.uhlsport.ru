...
<div class="feature_gloves">
	...
	?>
	<script>
        var filtertech = <?if($arCurDir[2] == "vratarskie_svitery" || $arCurDir[2] == "vratarskie_shorty_i_bryuki" || $arCurDir[2]=="igrovaya_obuv" || $arCurDir[2] == "igrovye_myachi" || $arCurDir[2]=="trenirovochnye_myachi" || $arCurDir[2]=="detskie_i_spetsialnye_myachi" || $arCurDir[2]=="futzalnye_myachi" || $arCurDir[2]=="zashchita_i_bandazhi" || $arCurDir[2]=="funktsionalnye_sumki" || $arCurDir[2] == "kollektsiya_braziliya_2014" || array_search("odezhda", $arCurDir) || array_search("trenirovochnye_aksessuary", $arCurDir) || array_search("aksessuary_dlya_myachey", $arCurDir) || array_search("vratarskie_aksessuary",$arCurDir)){echo "false";}else{echo "true";}?>;
        var filterprop = <?if($arCurDir[2] == "vratarskie_svitery" || $arCurDir[2] == "vratarskie_shorty_i_bryuki" || $arCurDir[2]=="funktsionalnye_sumki" || $arCurDir[2] == "kollektsiya_braziliya_2014"|| array_search("vratarskie_aksessuary",$arCurDir)){echo "true";}else{echo "false";}?>;
	...
	<div class="container_16">
		<div class="grid_12">
			<ul id="productlist" class="image-grid image-grid-left" style=" width: 730px;">
			<?$t = 0;?>
            ...
            <div>
                   ...
                   <hr style="margin:0; margin-left:10px; margin-right:20px; margin-bottom:20px; margin-top:-20px;">
                        <fieldset>
                            ...
                            <ul id="Foam" class="icons techninfos" style="margin-top:0;padding:0;display:none;">
                                    ...
                                    <li title="For pitches" rel="tooltip">
                                        <div><input data-name="Supersoft" data-key="Foam" type="checkbox" checked="checked" name="tech_1" value="supersoft">
                                        <img src="/images/prop/supersoft.png"></div>
                                        <span>Supersoft</span>
                                    </li>
                                    <li title="For pitches" rel="tooltip">
                                    ...
                                    <li title="Orange The Colour for ultrastrong grip. High-grip performance. New foam technology plus ‚high-grip‘ elements.Advantages: the foam has an ultra strong grip with optimum durability." rel="tooltip">
                                        <div><input data-name="Supergrip" data-key="Foam" type="checkbox" checked="checked" name="tech_1" value="supergrip">
                                        <img src="/images/prop/supergrip.png"></div>
                                        <span>Supergrip</span>
                                    </li>
                                    <li title="For artificial grass and hard courts" rel="tooltip">
                                        <div><input data-name="FLUO gruen" data-key="Foam" type="checkbox" checked="checked" name="tech_1" value="fluo_gruen">
                                        <img src="/images/prop/fluo_gruen.png"></div>
                                        <span>FLUO gruen</span>
                                    </li>
                                    <li title="For artificial grass and hard courts" rel="tooltip">
                                        <div><input data-name="FLUO gelb" data-key="Foam" type="checkbox" checked="checked" name="tech_1" value="fluo_gelb">
                                        <img src="/images/prop/fluo_gruen.png"></div>
                                        <span>FLUO gelb</span>
                                    </li>
                                    <li title="For artificial grass and hard courts" rel="tooltip">
                                        <div><input data-name="Kid sizes" data-key="Foam" type="checkbox" checked="checked" name="tech_1" value="kid">
                                        <img src="/images/prop/kid.png"></div>
                                        <span>Kid sizes</span>
                                    </li>
                                    <li title="For artificial grass and hard courts" rel="tooltip">
                                        <div><input data-name="Wind Breaker" data-key="Foam" type="checkbox" checked="checked" name="tech_1" value="kid">
                                        <img src="/images/prop/wind_breaker.png"></div>
                                        <span>Wind Breaker</span>
                                    </li>
                            </ul>
                        </fieldset>
                        <fieldset>
                            ...
                            <ul id="Cut" class="icons techninfos" style="margin-top:0;padding:0;display:none;">
                                    <li title="" rel="tooltip">
                                        <div><input data-name="Artificial grass" data-key="Cut" type="checkbox" checked="checked" name="tech_2" value="artificial_grass">
                                        <img src="/images/prop/artificial_grass.png"></div>
                                    ...
                                    <li title="" rel="tooltip">
                                        <div><input data-name="Close Cut" data-key="Cut" type="checkbox" checked="checked" name="tech_2" value="enger_schnitt">
                                        <img src="/images/prop/enger_schnitt.png"></div>
                                        <span>Close Cut</span>
                                    </li>
                                    ...
                                    <li title="Seemless all-round grip for perfect ball control" rel="tooltip">
                                        <div><input data-name="360° wrap" data-key="Cut" type="checkbox" checked="checked" name="tech_2" value="360_wrap">
                                        <img src="/images/prop/360_wrap.png"></div>
                                        <span>360° wrap</span>
                                    </li>
                                    <li title="" rel="tooltip">
                                        <div><input data-name="Negative" data-key="Cut" type="checkbox" checked="checked" name="tech_2" value="halfnegative">
                                        <img src="/images/prop/negative.png"></div>
                                        <span>Negative</span>
                                    </li>
                                    <li title="" rel="tooltip">
                                        <div><input data-name="Absolutroll" data-key="Cut" type="checkbox" checked="checked" name="tech_2" value="absolutroll">
                                        <img src="/images/prop/absolutroll.png"></div>
                                        <span>Absolutroll</span>
                                    </li>
                                    <li title="" rel="tooltip">
                                        <div><input data-name="Fingersurround" data-key="Cut" type="checkbox" checked="checked" name="tech_2" value="fingersurround">
                                        <img src="/images/prop/bionikframe.png"></div>
                                        <span>Fingersurround</span>
                                    </li>
                                    <li title="" rel="tooltip">
                                        <div><input data-name="Half Negative" data-key="Cut" type="checkbox" checked="checked" name="tech_2" value="halfnegative">
                                        <img src="/images/prop/halfnegative.png"></div>
                                        <span>Half Negative</span> 
                                    </li> 
                            </ul>
                        </fieldset>
                        <fieldset>
                            ...
                            <ul id="FingerProtection" class="icons techninfos" style="margin-top:0;padding:0;display:none;">
								...
								<li title="Classic cut with new 360° wrap grants a maximized catching area and perfect fitting" rel="tooltip">
									<div><input data-name="360° wrap" data-key="FingerProtection" type="checkbox" checked="checked" name="tech_3" value="360_wrap">
									<img src="/images/prop/360_wrap.png"></div>
									<span>360° wrap</span>
								</li>
								<li>
								...
								<li title="">
									<div><input data-name="HANDBETT" data-key="FingerProtection" type="checkbox" checked="checked" name="tech_3" value="handbett">
									<img src="/images/prop/handbett.png"></div>
									<span>HANDBETT</span>
								</li>
								<li title="">
									<div><input data-name="3D Shockzone" data-key="FingerProtection" type="checkbox" checked="checked" name="tech_3" value="shockzone3d">
									<img src="/images/prop/shockzone3d.png"></div>
									<span>3D Shockzone</span>
								</li>
                            </ul>
                        </fieldset>
                ...
                <fieldset>
                    <legend>Основной цвет</legend>
                        ...
                        <label title="red" style="display:block;margin-top:3px;float:left;width:10px;height:10px;border:1px solid black;background-color:#FF0000;" class="jquery-checkbox-checked light" labelfor="color">
                        </label>
						Красный<br>
                        <input style="clear:both;" type="checkbox" name="color" checked="checked" value="yellow"> 
                        <label title="yellow" style="display:block;margin-top:3px;float:left;width:10px;height:10px;border:1px solid black;background-color:#FFF000;" class="jquery-checkbox-checked light" labelfor="color">
                        </label>
						Желтый<br>
                        <input style="clear:both;" type="checkbox" name="color" checked="checked" value="green"> 
                        <label title="green" style="display:block;margin-top:3px;float:left;width:10px;height:10px;border:1px solid black;background-color:#329b32;" class="jquery-checkbox-checked light" labelfor="color">
                        </label>
						Зеленый<br>
            ...
            <div>
                ...
                <fieldset>
					...
					<input style="clear:both;" type="checkbox" name="color" checked="checked" value="yellow"> 
						...
						Оранжевый<br>
                        <input style="clear:both;" type="checkbox" name="color" checked="checked" value="red"> 
                        <label title="red" style="display:block;margin-top:3px;float:left;width:10px;height:10px;border:1px solid black;background-color:#CB1009;" class="jquery-checkbox-checked light" labelfor="color">
                        </label>
						Красный<br>
                </fieldset>
            </div>
            ...
            <div>
                ...
                <fieldset>
                    <legend>Основной цвет</legend>
						...
						Белый<br>
                        <input style="clear:both;" type="checkbox" name="color" checked="checked" value="grey"> 
                        <label title="grey" style="display:block;margin-top:3px;float:left;width:10px;height:10px;border:1px solid black;background-color:#4F565B;" class="jquery-checkbox-checked " labelfor="color">
                        </label>
						Серый<br>
                </fieldset>
            </div>
...
Желтый<br>
	...
	<?}
	if(array_search("odezhda", $arCurDir) || array_search("trenirovochnye_aksessuary", $arCurDir) || array_search("aksessuary_dlya_myachey", $arCurDir)){?>
		<div class="grid_4" id="ffilter">
        <div class="filter_top"></div>
        <div class="filter">
            <div>
...
Черный<br>
	...
	<?}
	if(array_search("vratarskie_aksessuary",$arCurDir)){?>
		<div class="grid_4" id="ffilter">
        <div class="filter_top"></div>
        <div class="filter">
            <div>
