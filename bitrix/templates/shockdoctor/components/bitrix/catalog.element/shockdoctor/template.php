...
<?
		reset($arResult['PROPERTIES']['MORE_PHOTO']['VALUE']);
		$arFirstPhoto = current($arResult['PROPERTIES']['MORE_PHOTO']['VALUE']);
...
<div class="bx_item_container">
				...
				*/ ?>
				...
				<div class="product-options-bottom">
						...
						<label for="qty"><? echo GetMessage('CATALOG_QUANTITY'); ?>:</label>
							...
							<button class="button btn-cart cta" href="javascript:void(0);"  id="<? echo $arItemIDs['BUY_LINK']; ?>">
		...
		<div class="bx_rt product-media">
				...
				<?
					$arFile = CFile::GetFileArray($arFirstPhoto);
					
					$file = CFile::ResizeImageGet($arFile, array('width'=>150, 'height'=>150), BX_RESIZE_IMAGE_PROPORTIONAL, true);
						...
						<div class="bx_bigimages" id="<? echo $arItemIDs['BIG_IMG_CONT_ID']; ?>">
								...
								<div class="bx_bigimages_imgcontainer">
										<span class="bx_bigimages_aligner">
												<a class="product-image image-zoom" id="main-image" title="" href="<? echo $arFirstPhoto['SRC']; ?>" />
													<img
...
<div class="product-info">
		...
		<div class="product-info-slide product-description">
				<div class="module-b">
						...
						<div class="product-description-left module-b-left">
								<?
						...
						<div class="product-description-right module-b-right">
