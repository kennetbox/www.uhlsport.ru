...
<div id="<?=$cartId?>" class="<?=$cartStyle?>">
	<a id="cartHeader" href="/personal/cart/" class="skip-link skip-cart">
		<?/*$frame = $this->createFrame('bx_cart_block', false)->begin()?>
			<?require(realpath(dirname(__FILE__)).'/ajax_template.php')?>
		<?$frame->beginStub()?>
		<?$frame->end()*/?>
		<?/*<strong class="bx_small_cart"><?=GetMessage('TSB1_CART')?></strong>*/?>
		<i class="material-icons">shopping_cart</i>
		<span class="count"><?=$arResult["NUM_PRODUCTS"]; ?></span> шт.
	</a>
</div>
