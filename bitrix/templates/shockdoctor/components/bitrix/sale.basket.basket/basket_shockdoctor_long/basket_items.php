							...
							?>
								<td class="qnty-column">
									...
									<?  if ( floatval($arItem["MEASURE_RATIO"]) != 0 ): ?>
										<a href="javascript:void(0);" class="qty-btn minus dnone" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'down', <?=$useFloatQuantityJS?>);"></a>
									<? 	endif; ?>
									...
									<?  if ( floatval($arItem["MEASURE_RATIO"]) != 0 ): ?>
										<a href="javascript:void(0);" class="qty-btn plus dnone" onclick="setQuantity(<?=$arItem["ID"]?>, <?=$arItem["MEASURE_RATIO"]?>, 'up', <?=$useFloatQuantityJS?>);"></a>
									<? 	endif; ?>
