			...
			<div class="col-1 new-users col-xs-12 col-sm-6">
                <div class="theme-block">
                    ...
                    <div class="buttons-set">
                        <a title="Create an Account" class="button" href="https://www.shockdoctor.com/customer/account/create/" onclick="return false;"><b class="ink animate" style="height: 249px; width: 249px; top: -101.5px; left: 27px;"></b><span><span>РЕГИСТРАЦИЯ</span></span></a>
                    </div>
                </div>
            </div>
