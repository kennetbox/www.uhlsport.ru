...
<div class="section fieldset clearfix">
	...
	if (is_array($arResult["ORDER_PROP"]["USER_PROFILES"]) && !empty($arResult["ORDER_PROP"]["USER_PROFILES"])):
		...
		?>
			...
			<div class="field">
				...
				<div class="input-box">
					<select id="ID_PROFILE_ID" class="input-text" name="PROFILE_ID" onChange="SetContact(this.value)">
...
<div class="bx_section fieldset clearfix">
	...
	*/?>
	<div id="sale_order_props">
		...
		<?
			// Свойства, которые не сохраняются в Профиль и заполняются каждый раз снова и снова
			PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"]);
			
			// Свойства, которые могут быть сохранены в Профиль
