...
?>
		<div class="modules">
				...
				<div class="top-products-header grouped-products-header">
						<p class="top-products-heading">Вам может понравиться:</p>
				</div>

				<div class="grouped-products-recomended grouped-products-groups">
						<div class="top-products-group">
<?
	$templateData = array(
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	<div class="top-product grouped-product">
		...
		<a href="<? echo $elementHref; //$arItem['DETAIL_PAGE_URL']; ?>" alt="<? echo $imgTitle; ?>">
		...
		<h4>
				<span class="price">
						...
						if (!empty($arItem['MIN_PRICE']))
						{
							...
							{
								echo "от ".$arItem['MIN_PRICE']['PRINT_DISCOUNT_VALUE'];
								/*
								GetMessage(
