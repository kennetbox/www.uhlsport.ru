...
<div class="main list-product">
    <div class="list-header">
        <div class="list-header-contents">
            ...
            <div class="toolbar">
				<h2 class="list-header-count">Найдено <strong><?=$count ?></strong></h2>
            </div>
        </div>
    </div> <!-- end list-header -->
...
if (!empty($arResult['ITEMS']))
{
	...
	{
		?>
			<div class="clearfix search-pager width_100">
...
?>
        ...
        <div class="list-toolbar">
			...
			<div class="search-toolbar">
				...
				<ul>
					<li class="search-toolbar-current">
						<?=sklonenie($count, $forms)?> <em>(<?=$count?>)</em>
					</li>
				</ul>
			</div>
