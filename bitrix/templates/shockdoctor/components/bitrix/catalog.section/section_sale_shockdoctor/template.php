	...
	<div class="grouped-product">
		...
		<h4>
			<span itemtype="http://schema.org/Offer" itemscope="" class="price-box">
				...
				<? if($arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["VALUE"]) { ?>
					<span class="old-price">
						<span class="price-label">Regular Price:</span>
						<span class="price" id="old-price-274"><?=$arItem["OFFERS"][0]["PROPERTIES"]["OLD_PRICE"]["VALUE"] ?> руб.</span>
					</span>
				<? } ?>
...
?>
        ...
        <div class="list-toolbar">
			...
			<?	
				...
				$CURRENT_SECTION_ID = 62;
				
				$APPLICATION->IncludeComponent(
						"bitrix:catalog.smart.filter",
						"visual_vertical_sale_shockdoctor",
						Array(
