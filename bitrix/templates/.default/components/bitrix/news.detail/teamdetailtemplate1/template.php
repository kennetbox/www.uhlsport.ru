<div class="container_16">
    ...
    <div class="info">
        <label>Лига</label><?=$arResult["PROPERTIES"]["LEAGUE"]["VALUE"]?>
    </div>
                <br>
    ...
    <div>
		...
		<h3>More information about the sponsorpartner here...</h3>
			...
			<?if($arResult["PROPERTIES"]["GOOGLE"]["VALUE"] != ""){?><a href="<?=$arResult["PROPERTIES"]["GOOGLE"]["VALUE"]?>" target="_blank" title="Google+">
    ...
    <div class="grid8 effects">
        <div class="sub">
			<a title="<?=$arResult["NAME"]?>" href="<?=$arResult["DETAIL_PICTURE"]["SRC"]?>" rel="lightbox">
