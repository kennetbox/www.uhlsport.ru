...
<script type="text/javascript">
	...
	<form action="<?=POST_FORM_ACTION_URI;?>" method="POST" enctype="multipart/form-data" name="api_feedback_form" id="<?= $arParams['UNIQUE_FORM_ID']; ?>">
		...
		{?>
            ...
            <div class="grid_4 alpha">
                <input id="verein" name="author_work_company" placeholder="Club" type="text" value="">
            </div>
            <div class="grid_4 omega">
                <input id="strasse" name="strasse" placeholder="Street " type="text" value="">
            </div>
            <div class="clear"></div>

            <div class="grid_2 alpha">
                <input id="plz" name="author_adress" placeholder="Zip-Code" type="text" value="">
            </div>
            <div class="grid_2">
                <input id="ort" name="author_city" placeholder="City" type="text" value="">
            </div>
			<div class="grid_4 omega">
...
<option value="Zimbabwe">Zimbabwe</option>
			...
			<div class="grid_2 alpha">
                <input id="telefon" name="author_personal_mobile" placeholder="Phone" type="text" value="">
            </div>
            <div class="grid_2">
                <input id="fax" name="author_fax" placeholder="Fax" type="text" value="">
            </div>
            <div class="grid_4 omega">
		...
		<?}?>
			...
			<input style="width: 448px;" type="file"
				   name="UPLOAD_FILES[]"
		...
		if(count($arParams['DISPLAY_FIELDS']) > 0)
		{
			foreach($arParams['DISPLAY_FIELDS'] as $FIELD)
			{
				...
				{?>
				<div class="grid_8 alpha omega">
					<textarea placeholder="Message *" style="<?= $arParams['FORM_STYLE_TEXTAREA'] ?>" <?if($arParams['INCLUDE_PLACEHOLDER']):?> placeholder="<?= $field_name ?>" <?endif?>
					          name="<?= ToLower($FIELD) ?>"
		...
		<div style="text-align: center">
			<input type="submit" name="submit" id="<?=$arParams['FORM_SUBMIT_ID'];?>" value="<?=$arResult['FORM_SUBMIT_VALUE'];?>">
		</div>
